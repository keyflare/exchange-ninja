...
public val FlagIcons.Ars: ImageVector
    get() {
        if (_ars != null) {
            return _ars!!
        }
        _ars = Builder(name = "Ars", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFFffda44)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveToRelative(332.515f, 256.0f)
                ...
                lineToRelative(31.265f, -14.707f)
                lineToRelative(-16.649f, -30.278f)
...
private var _ars: ImageVector? = null
