...
public val FlagIcons.Pab: ImageVector
    get() {
        if (_pab != null) {
            return _pab!!
        }
        _pab = Builder(name = "Pab", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF0052b4)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, -97.355f, 0.0f, -256.0f, 0.0f, -256.0f)
            ...
            path(fill = SolidColor(Color(0xFFd80027)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-97.355f, 0.0f, -256.0f, 0.0f, -256.0f, 0.0f)
                reflectiveCurveToRelative(0.0f, -166.957f, 0.0f, -256.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF0052b4)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
            ...
            path(fill = SolidColor(Color(0xFFd80027)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveToRelative(359.611f, 289.391f)
                lineToRelative(16.577f, 51.018f)
                horizontalLineToRelative(53.643f)
...
private var _pab: ImageVector? = null
